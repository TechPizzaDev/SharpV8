...
namespace Microsoft.ClearScript.V8
{
    internal sealed class V8DebugListener
    {
        ...
        {
            V8SplitProxyNative.V8DebugCallback_ConnectClient(Handle);
        }

        public void SendCommand(string command)
        {
            V8SplitProxyNative.V8DebugCallback_SendCommand(Handle, command);
        }

        public void DisconnectClient()
        {
            V8SplitProxyNative.V8DebugCallback_DisconnectClient(Handle);
        }
